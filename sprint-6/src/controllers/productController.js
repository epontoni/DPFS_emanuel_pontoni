...
const getAllProducts = async (req, res, next) => {
  try {
    ...
    // Mapear para mantener compatibilidad con las vistas que esperan product.category como string
...
const createProduct = async (req, res, next) => {
  try {
    ...
    // Buscar o crear la categoría basada en el string recibido en el form
...
const getEditForm = async (req, res, next) => {
  try {
    ...
    res.render('products/edit', { product: pJson });
  } catch (error) {
    next(error);
  }
};
