...
app.post('/products', productValidator, productController.createProduct);
app.get('/products/:id', productController.getProductById);
app.get('/products/:id/edit', productController.getEditForm);
app.put('/products/:id', productValidator, productController.updateProduct);
app.post('/products/:id', productValidator, productController.updateProduct); // Para formularios HTML (con _method)
